...
# 📖 Rails-React-Starter <a name="about-project">

Hi there! Welcome to Rails-React-Starter</a>

This web app is a powerful starting point for building Rails-React web apps. By leveraging the Jsbundling-rails gem with webpack, it seamlessly integrates Rails and React, allowing for a smooth development experience.
...
- **Add babel and webpack congurations**
- **Add react and redux**
...
```snippet
  git clone https://github.com/UbdaNam/rails-react-starter.git
```
...
Feel free to check the [issues page](https://github.com/UbdaNam/rails-react-starter/issues).
